...
const makeMessagesSocket = (config) => {
    ...
    if (message?.interactiveMessage || message?.buttonsMessage || message?.listMessage) {
        binaryNodeContent.push({
            tag: 'biz',
            attrs: {},
            content: [{
    ...
    logger.debug({
        ...
        msgType,
        mediaType,
        hasInteractive: !!(message?.interactiveMessage || message?.buttonsMessage),
        hasMedia: !!mediaType
    }, `sending FULL EXTENDED newsletter message to ${jid}`)
